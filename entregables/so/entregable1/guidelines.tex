\textbf{Modo de entrega:} A través de la plataforma (de sebe subir el archivo \textit{.tar.gz} a la actividad que se creará para tal fin)
...
\begin{enumerate}
 \item Desarrollo de una \textit{shell}: \label{implementar_shell}
      ...
      \item Cree un directorio llamado \textbf{externalSO} a la misma altura que la shell para luego agregar esa ruta a la variable \textbf{RUTA}. El mismo debe contener lo siguiente:
      \begin{itemize}
