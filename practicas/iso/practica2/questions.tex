...
\begin{parts}
	\item Nombre al menos 3 editores de texto que puede utilizar desde linea de comandos.
	\item ¿En que se diferencia un editor de texto a los comandos cat, more o less? Enumere los modos de operación que posee el editor de textos vi.
 	\item Nombre los comandos mas comunes que se le pueden enviar al editor de textos vi.
\end{parts}
