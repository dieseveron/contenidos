...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item Latencia:
      12600 vueltas $\rightarrow$ 1' = 60 \s = 60000 \ms
      0,5 vueltas $\rightarrow$ x = 2,3809 \ms
      \item Transferencia:
      15 \mebishort\bits $\rightarrow$ 1 \s = 1000 \ms
      256 \bytes $\rightarrow$ x
      15728640 \bits $\rightarrow$ 1000 \ms
      2048 \bits $\rightarrow$ x = 0,1302
    \end{itemize}      
    \end{itemize}
  \end{itemize}
\end{frame}
