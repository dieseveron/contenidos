...
\begin{frame}
  ...
  \begin{enumerate}
	...
	\item Se monta el initrd como sistema de archivos raíz y se inicializan componentes esenciales (e.j.: scheduler)
	\item Se ejecuta el proceso \textit{init} y se desmonta en initrd
...
\begin{frame}
  ...
  \begin{itemize}
	  	...
	  	\item Cada uno es responsable de levantar o bajar una serie de servicios
  \end{itemize}
\end{frame}
